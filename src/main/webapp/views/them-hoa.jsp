...
<div class="container-fluid">
	<div class="row" style="background-color:#59961F;">
		...
		<div class="col-sm-10" style="background-color:#FFF;">
			<form class="form-horizontal" action="ThemHoaServlet" method="post" style="max-width:600px;margin:auto;padding:20px 0;">
				...
				<div class="form-group">
					...
					<div class="col-sm-9"> 
						<input class="form-control" type="text" name="txtTenBoHoa" value="${param.txtTenBoHoa}" />
					</div>
				</div>
				<div class="form-group">
